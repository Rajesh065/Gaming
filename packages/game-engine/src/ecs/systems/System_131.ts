...
import { Component_131 } from '../components/Component_131';

export class System_131 {
  public readonly name = 'SpecializedEngineSystem_131';
  public readonly priority = 1310;
  ...
  public update(components: Component_131[], deltaTime: number): void {
