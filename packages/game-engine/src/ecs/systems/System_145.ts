...
import { Component_145 } from '../components/Component_145';

export class System_145 {
  public readonly name = 'SpecializedEngineSystem_145';
  public readonly priority = 1450;
  ...
  public update(components: Component_145[], deltaTime: number): void {
