...
import { Component_125 } from '../components/Component_125';

export class System_125 {
  public readonly name = 'SpecializedEngineSystem_125';
  public readonly priority = 1250;
  ...
  public update(components: Component_125[], deltaTime: number): void {
