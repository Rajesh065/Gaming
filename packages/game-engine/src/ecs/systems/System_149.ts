...
import { Component_149 } from '../components/Component_149';

export class System_149 {
  public readonly name = 'SpecializedEngineSystem_149';
  public readonly priority = 1490;
  ...
  public update(components: Component_149[], deltaTime: number): void {
