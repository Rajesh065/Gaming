...
import { Component_147 } from '../components/Component_147';

export class System_147 {
  public readonly name = 'SpecializedEngineSystem_147';
  public readonly priority = 1470;
  ...
  public update(components: Component_147[], deltaTime: number): void {
