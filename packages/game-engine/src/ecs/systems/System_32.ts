...
export class System_32 {
  public readonly name = 'SpecializedEngineSystem_32';
  public readonly priority = 320;
  ...
  public update(components: Component_32[], deltaTime: number): void {
