...
import { Component_146 } from '../components/Component_146';

export class System_146 {
  public readonly name = 'SpecializedEngineSystem_146';
  public readonly priority = 1460;
  ...
  public update(components: Component_146[], deltaTime: number): void {
