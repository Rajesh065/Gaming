...
import { Component_140 } from '../components/Component_140';

export class System_140 {
  public readonly name = 'SpecializedEngineSystem_140';
  public readonly priority = 1400;
  ...
  public update(components: Component_140[], deltaTime: number): void {
