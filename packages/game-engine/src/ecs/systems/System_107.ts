...
import { Component_107 } from '../components/Component_107';

export class System_107 {
  public readonly name = 'SpecializedEngineSystem_107';
  public readonly priority = 1070;
  ...
  public update(components: Component_107[], deltaTime: number): void {
