...
import { Component_95 } from '../components/Component_95';

export class System_95 {
  public readonly name = 'SpecializedEngineSystem_95';
  ...
  public update(components: Component_95[], deltaTime: number): void {
