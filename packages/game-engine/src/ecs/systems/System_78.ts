...
import { Component_78 } from '../components/Component_78';

export class System_78 {
  public readonly name = 'SpecializedEngineSystem_78';
  public readonly priority = 780;
  ...
  public update(components: Component_78[], deltaTime: number): void {
