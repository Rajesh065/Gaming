...
import { Component_137 } from '../components/Component_137';

export class System_137 {
  public readonly name = 'SpecializedEngineSystem_137';
  public readonly priority = 1370;
  ...
  public update(components: Component_137[], deltaTime: number): void {
