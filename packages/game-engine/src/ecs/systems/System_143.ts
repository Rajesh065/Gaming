...
import { Component_143 } from '../components/Component_143';

export class System_143 {
  public readonly name = 'SpecializedEngineSystem_143';
  public readonly priority = 1430;
  ...
  public update(components: Component_143[], deltaTime: number): void {
