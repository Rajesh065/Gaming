...
import { Component_124 } from '../components/Component_124';

export class System_124 {
  public readonly name = 'SpecializedEngineSystem_124';
  public readonly priority = 1240;
  ...
  public update(components: Component_124[], deltaTime: number): void {
