...
import { Component_98 } from '../components/Component_98';

export class System_98 {
  public readonly name = 'SpecializedEngineSystem_98';
  public readonly priority = 980;
  ...
  public update(components: Component_98[], deltaTime: number): void {
