...
import { Component_139 } from '../components/Component_139';

export class System_139 {
  public readonly name = 'SpecializedEngineSystem_139';
  public readonly priority = 1390;
  ...
  public update(components: Component_139[], deltaTime: number): void {
