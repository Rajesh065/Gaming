...
import { Component_127 } from '../components/Component_127';

export class System_127 {
  public readonly name = 'SpecializedEngineSystem_127';
  public readonly priority = 1270;
  ...
  public update(components: Component_127[], deltaTime: number): void {
