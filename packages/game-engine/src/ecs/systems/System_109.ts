...
import { Component_109 } from '../components/Component_109';

export class System_109 {
  public readonly name = 'SpecializedEngineSystem_109';
  public readonly priority = 1090;
  ...
  public update(components: Component_109[], deltaTime: number): void {
