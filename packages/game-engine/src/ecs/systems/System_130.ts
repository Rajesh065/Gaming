...
import { Component_130 } from '../components/Component_130';

export class System_130 {
  public readonly name = 'SpecializedEngineSystem_130';
  public readonly priority = 1300;
  ...
  public update(components: Component_130[], deltaTime: number): void {
