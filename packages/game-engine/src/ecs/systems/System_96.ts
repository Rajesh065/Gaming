...
import { Component_96 } from '../components/Component_96';

export class System_96 {
  public readonly name = 'SpecializedEngineSystem_96';
  public readonly priority = 960;
  ...
  public update(components: Component_96[], deltaTime: number): void {
