...
import { Component_150 } from '../components/Component_150';

export class System_150 {
  public readonly name = 'SpecializedEngineSystem_150';
  ...
  public update(components: Component_150[], deltaTime: number): void {
