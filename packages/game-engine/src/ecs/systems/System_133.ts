...
import { Component_133 } from '../components/Component_133';

export class System_133 {
  public readonly name = 'SpecializedEngineSystem_133';
  public readonly priority = 1330;
  ...
  public update(components: Component_133[], deltaTime: number): void {
