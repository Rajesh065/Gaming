...
import { Component_122 } from '../components/Component_122';

export class System_122 {
  public readonly name = 'SpecializedEngineSystem_122';
  public readonly priority = 1220;
  ...
  public update(components: Component_122[], deltaTime: number): void {
