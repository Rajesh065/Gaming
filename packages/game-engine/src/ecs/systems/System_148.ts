...
import { Component_148 } from '../components/Component_148';

export class System_148 {
  public readonly name = 'SpecializedEngineSystem_148';
  public readonly priority = 1480;
  ...
  public update(components: Component_148[], deltaTime: number): void {
