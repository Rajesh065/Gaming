...
import { Component_129 } from '../components/Component_129';

export class System_129 {
  public readonly name = 'SpecializedEngineSystem_129';
  public readonly priority = 1290;
  ...
  public update(components: Component_129[], deltaTime: number): void {
