...
import { Component_128 } from '../components/Component_128';

export class System_128 {
  public readonly name = 'SpecializedEngineSystem_128';
  public readonly priority = 1280;
  ...
  public update(components: Component_128[], deltaTime: number): void {
