...
import { Component_138 } from '../components/Component_138';

export class System_138 {
  public readonly name = 'SpecializedEngineSystem_138';
  public readonly priority = 1380;
  ...
  public update(components: Component_138[], deltaTime: number): void {
