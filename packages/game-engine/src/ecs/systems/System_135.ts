...
import { Component_135 } from '../components/Component_135';

export class System_135 {
  public readonly name = 'SpecializedEngineSystem_135';
  public readonly priority = 1350;
  ...
  public update(components: Component_135[], deltaTime: number): void {
