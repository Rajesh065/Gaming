...
import { Component_123 } from '../components/Component_123';

export class System_123 {
  public readonly name = 'SpecializedEngineSystem_123';
  public readonly priority = 1230;
  ...
  public update(components: Component_123[], deltaTime: number): void {
