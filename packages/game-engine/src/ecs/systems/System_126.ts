...
import { Component_126 } from '../components/Component_126';

export class System_126 {
  public readonly name = 'SpecializedEngineSystem_126';
  public readonly priority = 1260;
  ...
  public update(components: Component_126[], deltaTime: number): void {
