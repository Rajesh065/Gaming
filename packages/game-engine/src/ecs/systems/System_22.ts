...
export class System_22 {
  public readonly name = 'SpecializedEngineSystem_22';
  public readonly priority = 220;
  ...
  public update(components: Component_22[], deltaTime: number): void {
