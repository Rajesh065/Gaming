...
import { Component_141 } from '../components/Component_141';

export class System_141 {
  public readonly name = 'SpecializedEngineSystem_141';
  public readonly priority = 1410;
  ...
  public update(components: Component_141[], deltaTime: number): void {
