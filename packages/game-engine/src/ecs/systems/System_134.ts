...
import { Component_134 } from '../components/Component_134';

export class System_134 {
  public readonly name = 'SpecializedEngineSystem_134';
  public readonly priority = 1340;
  ...
  public update(components: Component_134[], deltaTime: number): void {
