...
import { Component_132 } from '../components/Component_132';

export class System_132 {
  public readonly name = 'SpecializedEngineSystem_132';
  public readonly priority = 1320;
  ...
  public update(components: Component_132[], deltaTime: number): void {
