...
import { Component_121 } from '../components/Component_121';

export class System_121 {
  public readonly name = 'SpecializedEngineSystem_121';
  public readonly priority = 1210;
  ...
  public update(components: Component_121[], deltaTime: number): void {
