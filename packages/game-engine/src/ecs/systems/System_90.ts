...
import { Component_90 } from '../components/Component_90';

export class System_90 {
  public readonly name = 'SpecializedEngineSystem_90';
  ...
  public update(components: Component_90[], deltaTime: number): void {
