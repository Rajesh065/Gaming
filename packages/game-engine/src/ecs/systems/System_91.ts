...
import { Component_91 } from '../components/Component_91';

export class System_91 {
  public readonly name = 'SpecializedEngineSystem_91';
  public readonly priority = 910;
  ...
  public update(components: Component_91[], deltaTime: number): void {
