...
export interface ShaderUniforms_89 {
  uTime: number;
...
export class ShaderPipelineModule_89 {
  public readonly shaderId = 'pipeline_shader_89';
  public vertexSource: string;
  public fragmentSource: string;
  public uniforms: ShaderUniforms_89;
