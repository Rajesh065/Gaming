...
export interface ShaderUniforms_45 {
  uTime: number;
...
export class ShaderPipelineModule_45 {
  public readonly shaderId = 'pipeline_shader_45';
  public vertexSource: string;
  public fragmentSource: string;
  public uniforms: ShaderUniforms_45;
