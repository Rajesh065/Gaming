...
export interface ShaderUniforms_108 {
  uTime: number;
...
export class ShaderPipelineModule_108 {
  public readonly shaderId = 'pipeline_shader_108';
  public vertexSource: string;
  public fragmentSource: string;
  public uniforms: ShaderUniforms_108;
