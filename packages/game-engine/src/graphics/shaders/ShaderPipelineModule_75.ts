...
export interface ShaderUniforms_75 {
  uTime: number;
...
export class ShaderPipelineModule_75 {
  public readonly shaderId = 'pipeline_shader_75';
  public vertexSource: string;
  public fragmentSource: string;
  public uniforms: ShaderUniforms_75;
