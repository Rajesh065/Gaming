...
export interface ShaderUniforms_60 {
  uTime: number;
...
export class ShaderPipelineModule_60 {
  public readonly shaderId = 'pipeline_shader_60';
  public vertexSource: string;
  public fragmentSource: string;
  public uniforms: ShaderUniforms_60;
