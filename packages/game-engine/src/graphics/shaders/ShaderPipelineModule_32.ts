...
export interface ShaderUniforms_32 {
  uTime: number;
...
export class ShaderPipelineModule_32 {
  public readonly shaderId = 'pipeline_shader_32';
  public vertexSource: string;
  public fragmentSource: string;
  public uniforms: ShaderUniforms_32;
