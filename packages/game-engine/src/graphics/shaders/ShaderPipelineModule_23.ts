...
export interface ShaderUniforms_23 {
  uTime: number;
...
export class ShaderPipelineModule_23 {
  public readonly shaderId = 'pipeline_shader_23';
  public vertexSource: string;
  public fragmentSource: string;
  public uniforms: ShaderUniforms_23;
