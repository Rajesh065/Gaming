...
export interface ShaderUniforms_113 {
  uTime: number;
...
export class ShaderPipelineModule_113 {
  public readonly shaderId = 'pipeline_shader_113';
  public vertexSource: string;
  public fragmentSource: string;
  public uniforms: ShaderUniforms_113;
