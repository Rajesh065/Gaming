...
export interface ShaderUniforms_81 {
  uTime: number;
...
export class ShaderPipelineModule_81 {
  public readonly shaderId = 'pipeline_shader_81';
  public vertexSource: string;
  public fragmentSource: string;
  public uniforms: ShaderUniforms_81;
