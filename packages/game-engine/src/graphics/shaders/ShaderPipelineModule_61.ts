...
export interface ShaderUniforms_61 {
  uTime: number;
...
export class ShaderPipelineModule_61 {
  public readonly shaderId = 'pipeline_shader_61';
  public vertexSource: string;
  public fragmentSource: string;
  public uniforms: ShaderUniforms_61;
