...
export interface ShaderUniforms_120 {
  uTime: number;
...
export class ShaderPipelineModule_120 {
  public readonly shaderId = 'pipeline_shader_120';
  public vertexSource: string;
  public fragmentSource: string;
  public uniforms: ShaderUniforms_120;
