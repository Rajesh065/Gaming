...
export interface ShaderUniforms_103 {
  uTime: number;
...
export class ShaderPipelineModule_103 {
  public readonly shaderId = 'pipeline_shader_103';
  public vertexSource: string;
  public fragmentSource: string;
  public uniforms: ShaderUniforms_103;
