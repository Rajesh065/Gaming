...
export interface ShaderUniforms_51 {
  uTime: number;
...
export class ShaderPipelineModule_51 {
  public readonly shaderId = 'pipeline_shader_51';
  public vertexSource: string;
  public fragmentSource: string;
  public uniforms: ShaderUniforms_51;
