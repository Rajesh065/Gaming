...
export interface ShaderUniforms_79 {
  uTime: number;
...
export class ShaderPipelineModule_79 {
  public readonly shaderId = 'pipeline_shader_79';
  public vertexSource: string;
  public fragmentSource: string;
  public uniforms: ShaderUniforms_79;
