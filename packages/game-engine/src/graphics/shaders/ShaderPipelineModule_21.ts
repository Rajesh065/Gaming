...
export interface ShaderUniforms_21 {
  uTime: number;
...
export class ShaderPipelineModule_21 {
  public readonly shaderId = 'pipeline_shader_21';
  public vertexSource: string;
  public fragmentSource: string;
  public uniforms: ShaderUniforms_21;
