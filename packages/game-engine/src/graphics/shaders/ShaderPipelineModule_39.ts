...
export interface ShaderUniforms_39 {
  uTime: number;
...
export class ShaderPipelineModule_39 {
  public readonly shaderId = 'pipeline_shader_39';
  public vertexSource: string;
  public fragmentSource: string;
  public uniforms: ShaderUniforms_39;
