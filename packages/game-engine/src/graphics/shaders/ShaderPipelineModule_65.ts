...
export interface ShaderUniforms_65 {
  uTime: number;
...
export class ShaderPipelineModule_65 {
  public readonly shaderId = 'pipeline_shader_65';
  public vertexSource: string;
  public fragmentSource: string;
  public uniforms: ShaderUniforms_65;
