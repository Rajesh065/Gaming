...
export interface ShaderUniforms_34 {
  uTime: number;
...
export class ShaderPipelineModule_34 {
  public readonly shaderId = 'pipeline_shader_34';
  public vertexSource: string;
  public fragmentSource: string;
  public uniforms: ShaderUniforms_34;
