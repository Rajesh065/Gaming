...
export interface ShaderUniforms_41 {
  uTime: number;
...
export class ShaderPipelineModule_41 {
  public readonly shaderId = 'pipeline_shader_41';
  public vertexSource: string;
  public fragmentSource: string;
  public uniforms: ShaderUniforms_41;
