...
export interface ShaderUniforms_17 {
  uTime: number;
...
export class ShaderPipelineModule_17 {
  public readonly shaderId = 'pipeline_shader_17';
  public vertexSource: string;
  public fragmentSource: string;
  public uniforms: ShaderUniforms_17;
