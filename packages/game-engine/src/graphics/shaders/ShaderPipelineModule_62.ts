...
export interface ShaderUniforms_62 {
  uTime: number;
...
export class ShaderPipelineModule_62 {
  public readonly shaderId = 'pipeline_shader_62';
  public vertexSource: string;
  public fragmentSource: string;
  public uniforms: ShaderUniforms_62;
