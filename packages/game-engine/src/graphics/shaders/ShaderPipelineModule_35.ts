...
export interface ShaderUniforms_35 {
  uTime: number;
...
export class ShaderPipelineModule_35 {
  public readonly shaderId = 'pipeline_shader_35';
  public vertexSource: string;
  public fragmentSource: string;
  public uniforms: ShaderUniforms_35;
