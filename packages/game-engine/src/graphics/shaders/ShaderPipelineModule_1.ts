...
export interface ShaderUniforms_1 {
  uTime: number;
...
export class ShaderPipelineModule_1 {
  public readonly shaderId = 'pipeline_shader_1';
  public vertexSource: string;
  public fragmentSource: string;
  public uniforms: ShaderUniforms_1;
