...
export interface ShaderUniforms_50 {
  uTime: number;
...
export class ShaderPipelineModule_50 {
  public readonly shaderId = 'pipeline_shader_50';
  public vertexSource: string;
  public fragmentSource: string;
  public uniforms: ShaderUniforms_50;
