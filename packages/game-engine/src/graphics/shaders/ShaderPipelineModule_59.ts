...
export interface ShaderUniforms_59 {
  uTime: number;
...
export class ShaderPipelineModule_59 {
  public readonly shaderId = 'pipeline_shader_59';
  public vertexSource: string;
  public fragmentSource: string;
  public uniforms: ShaderUniforms_59;
