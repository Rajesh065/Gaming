...
export interface ShaderUniforms_100 {
  uTime: number;
...
export class ShaderPipelineModule_100 {
  public readonly shaderId = 'pipeline_shader_100';
  public vertexSource: string;
  public fragmentSource: string;
  public uniforms: ShaderUniforms_100;
