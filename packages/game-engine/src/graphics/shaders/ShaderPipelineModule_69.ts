...
export interface ShaderUniforms_69 {
  uTime: number;
...
export class ShaderPipelineModule_69 {
  public readonly shaderId = 'pipeline_shader_69';
  public vertexSource: string;
  public fragmentSource: string;
  public uniforms: ShaderUniforms_69;
