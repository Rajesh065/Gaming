...
export interface ShaderUniforms_101 {
  uTime: number;
...
export class ShaderPipelineModule_101 {
  public readonly shaderId = 'pipeline_shader_101';
  public vertexSource: string;
  public fragmentSource: string;
  public uniforms: ShaderUniforms_101;
