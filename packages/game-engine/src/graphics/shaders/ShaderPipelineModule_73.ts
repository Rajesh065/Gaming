...
export interface ShaderUniforms_73 {
  uTime: number;
...
export class ShaderPipelineModule_73 {
  public readonly shaderId = 'pipeline_shader_73';
  public vertexSource: string;
  public fragmentSource: string;
  public uniforms: ShaderUniforms_73;
