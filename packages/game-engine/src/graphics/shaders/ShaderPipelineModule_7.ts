...
export interface ShaderUniforms_7 {
  uTime: number;
...
export class ShaderPipelineModule_7 {
  public readonly shaderId = 'pipeline_shader_7';
  public vertexSource: string;
  public fragmentSource: string;
  public uniforms: ShaderUniforms_7;
