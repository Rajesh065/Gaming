...
export interface ShaderUniforms_87 {
  uTime: number;
...
export class ShaderPipelineModule_87 {
  public readonly shaderId = 'pipeline_shader_87';
  public vertexSource: string;
  public fragmentSource: string;
  public uniforms: ShaderUniforms_87;
