...
export interface ShaderUniforms_110 {
  uTime: number;
...
export class ShaderPipelineModule_110 {
  public readonly shaderId = 'pipeline_shader_110';
  public vertexSource: string;
  public fragmentSource: string;
  public uniforms: ShaderUniforms_110;
