...
export interface ShaderUniforms_40 {
  uTime: number;
...
export class ShaderPipelineModule_40 {
  public readonly shaderId = 'pipeline_shader_40';
  public vertexSource: string;
  public fragmentSource: string;
  public uniforms: ShaderUniforms_40;
