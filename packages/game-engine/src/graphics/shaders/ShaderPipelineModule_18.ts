...
export interface ShaderUniforms_18 {
  uTime: number;
...
export class ShaderPipelineModule_18 {
  public readonly shaderId = 'pipeline_shader_18';
  public vertexSource: string;
  public fragmentSource: string;
  public uniforms: ShaderUniforms_18;
