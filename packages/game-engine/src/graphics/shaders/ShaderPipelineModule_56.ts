...
export interface ShaderUniforms_56 {
  uTime: number;
...
export class ShaderPipelineModule_56 {
  public readonly shaderId = 'pipeline_shader_56';
  public vertexSource: string;
  public fragmentSource: string;
  public uniforms: ShaderUniforms_56;
