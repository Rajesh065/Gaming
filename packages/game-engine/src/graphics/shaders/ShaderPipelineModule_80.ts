...
export interface ShaderUniforms_80 {
  uTime: number;
...
export class ShaderPipelineModule_80 {
  public readonly shaderId = 'pipeline_shader_80';
  public vertexSource: string;
  public fragmentSource: string;
  public uniforms: ShaderUniforms_80;
