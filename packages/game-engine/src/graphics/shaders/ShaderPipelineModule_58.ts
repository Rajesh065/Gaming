...
export interface ShaderUniforms_58 {
  uTime: number;
...
export class ShaderPipelineModule_58 {
  public readonly shaderId = 'pipeline_shader_58';
  public vertexSource: string;
  public fragmentSource: string;
  public uniforms: ShaderUniforms_58;
