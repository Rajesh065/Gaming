...
export interface ShaderUniforms_66 {
  uTime: number;
...
export class ShaderPipelineModule_66 {
  public readonly shaderId = 'pipeline_shader_66';
  public vertexSource: string;
  public fragmentSource: string;
  public uniforms: ShaderUniforms_66;
