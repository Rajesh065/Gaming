...
export interface ShaderUniforms_67 {
  uTime: number;
...
export class ShaderPipelineModule_67 {
  public readonly shaderId = 'pipeline_shader_67';
  public vertexSource: string;
  public fragmentSource: string;
  public uniforms: ShaderUniforms_67;
