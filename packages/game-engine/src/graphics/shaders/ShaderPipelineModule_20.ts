...
export interface ShaderUniforms_20 {
  uTime: number;
...
export class ShaderPipelineModule_20 {
  public readonly shaderId = 'pipeline_shader_20';
  public vertexSource: string;
  public fragmentSource: string;
  public uniforms: ShaderUniforms_20;
