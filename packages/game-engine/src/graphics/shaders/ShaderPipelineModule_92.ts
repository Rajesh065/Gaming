...
export interface ShaderUniforms_92 {
  uTime: number;
...
export class ShaderPipelineModule_92 {
  public readonly shaderId = 'pipeline_shader_92';
  public vertexSource: string;
  public fragmentSource: string;
  public uniforms: ShaderUniforms_92;
