...
export interface ShaderUniforms_86 {
  uTime: number;
...
export class ShaderPipelineModule_86 {
  public readonly shaderId = 'pipeline_shader_86';
  public vertexSource: string;
  public fragmentSource: string;
  public uniforms: ShaderUniforms_86;
