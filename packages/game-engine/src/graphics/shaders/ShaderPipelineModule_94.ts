...
export interface ShaderUniforms_94 {
  uTime: number;
...
export class ShaderPipelineModule_94 {
  public readonly shaderId = 'pipeline_shader_94';
  public vertexSource: string;
  public fragmentSource: string;
  public uniforms: ShaderUniforms_94;
