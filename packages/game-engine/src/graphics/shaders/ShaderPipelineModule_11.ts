...
export interface ShaderUniforms_11 {
  uTime: number;
...
export class ShaderPipelineModule_11 {
  public readonly shaderId = 'pipeline_shader_11';
  public vertexSource: string;
  public fragmentSource: string;
  public uniforms: ShaderUniforms_11;
