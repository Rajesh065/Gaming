...
export interface ShaderUniforms_57 {
  uTime: number;
...
export class ShaderPipelineModule_57 {
  public readonly shaderId = 'pipeline_shader_57';
  public vertexSource: string;
  public fragmentSource: string;
  public uniforms: ShaderUniforms_57;
