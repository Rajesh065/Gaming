...
export interface ShaderUniforms_54 {
  uTime: number;
...
export class ShaderPipelineModule_54 {
  public readonly shaderId = 'pipeline_shader_54';
  public vertexSource: string;
  public fragmentSource: string;
  public uniforms: ShaderUniforms_54;
