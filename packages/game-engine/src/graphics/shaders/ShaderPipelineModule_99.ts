...
export interface ShaderUniforms_99 {
  uTime: number;
...
export class ShaderPipelineModule_99 {
  public readonly shaderId = 'pipeline_shader_99';
  public vertexSource: string;
  public fragmentSource: string;
  public uniforms: ShaderUniforms_99;
