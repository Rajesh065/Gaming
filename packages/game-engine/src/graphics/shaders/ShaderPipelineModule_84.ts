...
export interface ShaderUniforms_84 {
  uTime: number;
...
export class ShaderPipelineModule_84 {
  public readonly shaderId = 'pipeline_shader_84';
  public vertexSource: string;
  public fragmentSource: string;
  public uniforms: ShaderUniforms_84;
