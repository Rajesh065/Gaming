...
export interface ShaderUniforms_105 {
  uTime: number;
...
export class ShaderPipelineModule_105 {
  public readonly shaderId = 'pipeline_shader_105';
  public vertexSource: string;
  public fragmentSource: string;
  public uniforms: ShaderUniforms_105;
