...
export interface ShaderUniforms_48 {
  uTime: number;
...
export class ShaderPipelineModule_48 {
  public readonly shaderId = 'pipeline_shader_48';
  public vertexSource: string;
  public fragmentSource: string;
  public uniforms: ShaderUniforms_48;
