...
export interface ShaderUniforms_16 {
  uTime: number;
...
export class ShaderPipelineModule_16 {
  public readonly shaderId = 'pipeline_shader_16';
  public vertexSource: string;
  public fragmentSource: string;
  public uniforms: ShaderUniforms_16;
