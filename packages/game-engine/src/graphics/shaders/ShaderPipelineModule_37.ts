...
export interface ShaderUniforms_37 {
  uTime: number;
...
export class ShaderPipelineModule_37 {
  public readonly shaderId = 'pipeline_shader_37';
  public vertexSource: string;
  public fragmentSource: string;
  public uniforms: ShaderUniforms_37;
