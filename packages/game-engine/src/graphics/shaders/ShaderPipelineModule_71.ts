...
export interface ShaderUniforms_71 {
  uTime: number;
...
export class ShaderPipelineModule_71 {
  public readonly shaderId = 'pipeline_shader_71';
  public vertexSource: string;
  public fragmentSource: string;
  public uniforms: ShaderUniforms_71;
