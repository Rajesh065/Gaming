...
export interface ShaderUniforms_72 {
  uTime: number;
...
export class ShaderPipelineModule_72 {
  public readonly shaderId = 'pipeline_shader_72';
  public vertexSource: string;
  public fragmentSource: string;
  public uniforms: ShaderUniforms_72;
