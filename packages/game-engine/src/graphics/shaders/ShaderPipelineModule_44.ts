...
export interface ShaderUniforms_44 {
  uTime: number;
...
export class ShaderPipelineModule_44 {
  public readonly shaderId = 'pipeline_shader_44';
  public vertexSource: string;
  public fragmentSource: string;
  public uniforms: ShaderUniforms_44;
