...
export interface ShaderUniforms_97 {
  uTime: number;
...
export class ShaderPipelineModule_97 {
  public readonly shaderId = 'pipeline_shader_97';
  public vertexSource: string;
  public fragmentSource: string;
  public uniforms: ShaderUniforms_97;
