...
export interface ShaderUniforms_64 {
  uTime: number;
...
export class ShaderPipelineModule_64 {
  public readonly shaderId = 'pipeline_shader_64';
  public vertexSource: string;
  public fragmentSource: string;
  public uniforms: ShaderUniforms_64;
