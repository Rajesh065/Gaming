...
export interface ShaderUniforms_27 {
  uTime: number;
...
export class ShaderPipelineModule_27 {
  public readonly shaderId = 'pipeline_shader_27';
  public vertexSource: string;
  public fragmentSource: string;
  public uniforms: ShaderUniforms_27;
