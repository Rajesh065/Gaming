...
export interface ShaderUniforms_5 {
  uTime: number;
...
export class ShaderPipelineModule_5 {
  public readonly shaderId = 'pipeline_shader_5';
  public vertexSource: string;
  public fragmentSource: string;
  public uniforms: ShaderUniforms_5;
