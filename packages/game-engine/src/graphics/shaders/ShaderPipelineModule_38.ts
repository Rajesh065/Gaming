...
export interface ShaderUniforms_38 {
  uTime: number;
...
export class ShaderPipelineModule_38 {
  public readonly shaderId = 'pipeline_shader_38';
  public vertexSource: string;
  public fragmentSource: string;
  public uniforms: ShaderUniforms_38;
