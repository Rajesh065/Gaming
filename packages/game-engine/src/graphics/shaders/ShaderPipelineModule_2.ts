...
export interface ShaderUniforms_2 {
  uTime: number;
...
export class ShaderPipelineModule_2 {
  public readonly shaderId = 'pipeline_shader_2';
  public vertexSource: string;
  public fragmentSource: string;
  public uniforms: ShaderUniforms_2;
