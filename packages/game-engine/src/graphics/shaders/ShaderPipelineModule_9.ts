...
export interface ShaderUniforms_9 {
  uTime: number;
...
export class ShaderPipelineModule_9 {
  public readonly shaderId = 'pipeline_shader_9';
  public vertexSource: string;
  public fragmentSource: string;
  public uniforms: ShaderUniforms_9;
