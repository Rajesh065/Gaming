...
export interface ShaderUniforms_106 {
  uTime: number;
...
export class ShaderPipelineModule_106 {
  public readonly shaderId = 'pipeline_shader_106';
  public vertexSource: string;
  public fragmentSource: string;
  public uniforms: ShaderUniforms_106;
