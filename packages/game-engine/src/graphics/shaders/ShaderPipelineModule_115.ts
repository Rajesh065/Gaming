...
export interface ShaderUniforms_115 {
  uTime: number;
...
export class ShaderPipelineModule_115 {
  public readonly shaderId = 'pipeline_shader_115';
  public vertexSource: string;
  public fragmentSource: string;
  public uniforms: ShaderUniforms_115;
