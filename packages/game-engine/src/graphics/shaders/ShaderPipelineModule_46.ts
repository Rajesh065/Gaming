...
export interface ShaderUniforms_46 {
  uTime: number;
...
export class ShaderPipelineModule_46 {
  public readonly shaderId = 'pipeline_shader_46';
  public vertexSource: string;
  public fragmentSource: string;
  public uniforms: ShaderUniforms_46;
