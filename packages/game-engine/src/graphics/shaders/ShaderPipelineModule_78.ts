...
export interface ShaderUniforms_78 {
  uTime: number;
...
export class ShaderPipelineModule_78 {
  public readonly shaderId = 'pipeline_shader_78';
  public vertexSource: string;
  public fragmentSource: string;
  public uniforms: ShaderUniforms_78;
