...
export interface ShaderUniforms_8 {
  uTime: number;
...
export class ShaderPipelineModule_8 {
  public readonly shaderId = 'pipeline_shader_8';
  public vertexSource: string;
  public fragmentSource: string;
  public uniforms: ShaderUniforms_8;
