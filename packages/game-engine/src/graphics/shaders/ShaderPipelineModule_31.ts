...
export interface ShaderUniforms_31 {
  uTime: number;
...
export class ShaderPipelineModule_31 {
  public readonly shaderId = 'pipeline_shader_31';
  public vertexSource: string;
  public fragmentSource: string;
  public uniforms: ShaderUniforms_31;
