...
export interface ShaderUniforms_55 {
  uTime: number;
...
export class ShaderPipelineModule_55 {
  public readonly shaderId = 'pipeline_shader_55';
  public vertexSource: string;
  public fragmentSource: string;
  public uniforms: ShaderUniforms_55;
