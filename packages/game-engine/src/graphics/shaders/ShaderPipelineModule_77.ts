...
export interface ShaderUniforms_77 {
  uTime: number;
...
export class ShaderPipelineModule_77 {
  public readonly shaderId = 'pipeline_shader_77';
  public vertexSource: string;
  public fragmentSource: string;
  public uniforms: ShaderUniforms_77;
