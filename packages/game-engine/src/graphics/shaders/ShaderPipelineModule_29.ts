...
export interface ShaderUniforms_29 {
  uTime: number;
...
export class ShaderPipelineModule_29 {
  public readonly shaderId = 'pipeline_shader_29';
  public vertexSource: string;
  public fragmentSource: string;
  public uniforms: ShaderUniforms_29;
