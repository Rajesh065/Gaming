...
export interface ShaderUniforms_30 {
  uTime: number;
...
export class ShaderPipelineModule_30 {
  public readonly shaderId = 'pipeline_shader_30';
  public vertexSource: string;
  public fragmentSource: string;
  public uniforms: ShaderUniforms_30;
