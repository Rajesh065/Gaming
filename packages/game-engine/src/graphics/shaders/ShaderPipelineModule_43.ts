...
export interface ShaderUniforms_43 {
  uTime: number;
...
export class ShaderPipelineModule_43 {
  public readonly shaderId = 'pipeline_shader_43';
  public vertexSource: string;
  public fragmentSource: string;
  public uniforms: ShaderUniforms_43;
