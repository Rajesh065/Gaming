...
export interface ShaderUniforms_95 {
  uTime: number;
...
export class ShaderPipelineModule_95 {
  public readonly shaderId = 'pipeline_shader_95';
  public vertexSource: string;
  public fragmentSource: string;
  public uniforms: ShaderUniforms_95;
