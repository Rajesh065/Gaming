...
export interface ShaderUniforms_114 {
  uTime: number;
...
export class ShaderPipelineModule_114 {
  public readonly shaderId = 'pipeline_shader_114';
  public vertexSource: string;
  public fragmentSource: string;
  public uniforms: ShaderUniforms_114;
