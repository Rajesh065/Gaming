...
export interface ShaderUniforms_33 {
  uTime: number;
...
export class ShaderPipelineModule_33 {
  public readonly shaderId = 'pipeline_shader_33';
  public vertexSource: string;
  public fragmentSource: string;
  public uniforms: ShaderUniforms_33;
