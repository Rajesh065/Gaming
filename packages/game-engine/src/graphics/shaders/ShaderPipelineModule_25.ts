...
export interface ShaderUniforms_25 {
  uTime: number;
...
export class ShaderPipelineModule_25 {
  public readonly shaderId = 'pipeline_shader_25';
  public vertexSource: string;
  public fragmentSource: string;
  public uniforms: ShaderUniforms_25;
