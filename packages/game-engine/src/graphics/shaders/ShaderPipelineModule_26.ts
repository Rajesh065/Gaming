...
export interface ShaderUniforms_26 {
  uTime: number;
...
export class ShaderPipelineModule_26 {
  public readonly shaderId = 'pipeline_shader_26';
  public vertexSource: string;
  public fragmentSource: string;
  public uniforms: ShaderUniforms_26;
