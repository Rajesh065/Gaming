...
export interface ShaderUniforms_83 {
  uTime: number;
...
export class ShaderPipelineModule_83 {
  public readonly shaderId = 'pipeline_shader_83';
  public vertexSource: string;
  public fragmentSource: string;
  public uniforms: ShaderUniforms_83;
