...
export interface ShaderUniforms_19 {
  uTime: number;
...
export class ShaderPipelineModule_19 {
  public readonly shaderId = 'pipeline_shader_19';
  public vertexSource: string;
  public fragmentSource: string;
  public uniforms: ShaderUniforms_19;
