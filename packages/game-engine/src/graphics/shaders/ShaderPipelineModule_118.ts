...
export interface ShaderUniforms_118 {
  uTime: number;
...
export class ShaderPipelineModule_118 {
  public readonly shaderId = 'pipeline_shader_118';
  public vertexSource: string;
  public fragmentSource: string;
  public uniforms: ShaderUniforms_118;
