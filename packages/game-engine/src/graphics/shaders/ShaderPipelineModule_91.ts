...
export interface ShaderUniforms_91 {
  uTime: number;
...
export class ShaderPipelineModule_91 {
  public readonly shaderId = 'pipeline_shader_91';
  public vertexSource: string;
  public fragmentSource: string;
  public uniforms: ShaderUniforms_91;
