...
export interface ShaderUniforms_90 {
  uTime: number;
...
export class ShaderPipelineModule_90 {
  public readonly shaderId = 'pipeline_shader_90';
  public vertexSource: string;
  public fragmentSource: string;
  public uniforms: ShaderUniforms_90;
