...
export interface ShaderUniforms_15 {
  uTime: number;
...
export class ShaderPipelineModule_15 {
  public readonly shaderId = 'pipeline_shader_15';
  public vertexSource: string;
  public fragmentSource: string;
  public uniforms: ShaderUniforms_15;
