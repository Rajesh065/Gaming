...
export interface ShaderUniforms_119 {
  uTime: number;
...
export class ShaderPipelineModule_119 {
  public readonly shaderId = 'pipeline_shader_119';
  public vertexSource: string;
  public fragmentSource: string;
  public uniforms: ShaderUniforms_119;
