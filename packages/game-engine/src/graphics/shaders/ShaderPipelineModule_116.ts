...
export interface ShaderUniforms_116 {
  uTime: number;
...
export class ShaderPipelineModule_116 {
  public readonly shaderId = 'pipeline_shader_116';
  public vertexSource: string;
  public fragmentSource: string;
  public uniforms: ShaderUniforms_116;
