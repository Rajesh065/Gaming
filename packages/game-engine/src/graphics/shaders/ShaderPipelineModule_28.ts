...
export interface ShaderUniforms_28 {
  uTime: number;
...
export class ShaderPipelineModule_28 {
  public readonly shaderId = 'pipeline_shader_28';
  public vertexSource: string;
  public fragmentSource: string;
  public uniforms: ShaderUniforms_28;
