...
export interface ShaderUniforms_12 {
  uTime: number;
...
export class ShaderPipelineModule_12 {
  public readonly shaderId = 'pipeline_shader_12';
  public vertexSource: string;
  public fragmentSource: string;
  public uniforms: ShaderUniforms_12;
