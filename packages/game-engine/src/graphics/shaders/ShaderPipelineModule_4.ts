...
export interface ShaderUniforms_4 {
  uTime: number;
...
export class ShaderPipelineModule_4 {
  public readonly shaderId = 'pipeline_shader_4';
  public vertexSource: string;
  public fragmentSource: string;
  public uniforms: ShaderUniforms_4;
