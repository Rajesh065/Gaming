...
export interface ShaderUniforms_42 {
  uTime: number;
...
export class ShaderPipelineModule_42 {
  public readonly shaderId = 'pipeline_shader_42';
  public vertexSource: string;
  public fragmentSource: string;
  public uniforms: ShaderUniforms_42;
