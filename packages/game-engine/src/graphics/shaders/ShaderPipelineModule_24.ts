...
export interface ShaderUniforms_24 {
  uTime: number;
...
export class ShaderPipelineModule_24 {
  public readonly shaderId = 'pipeline_shader_24';
  public vertexSource: string;
  public fragmentSource: string;
  public uniforms: ShaderUniforms_24;
