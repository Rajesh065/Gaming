...
export interface ShaderUniforms_14 {
  uTime: number;
...
export class ShaderPipelineModule_14 {
  public readonly shaderId = 'pipeline_shader_14';
  public vertexSource: string;
  public fragmentSource: string;
  public uniforms: ShaderUniforms_14;
