...
export interface ShaderUniforms_36 {
  uTime: number;
...
export class ShaderPipelineModule_36 {
  public readonly shaderId = 'pipeline_shader_36';
  public vertexSource: string;
  public fragmentSource: string;
  public uniforms: ShaderUniforms_36;
