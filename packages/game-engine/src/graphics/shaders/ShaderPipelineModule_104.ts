...
export interface ShaderUniforms_104 {
  uTime: number;
...
export class ShaderPipelineModule_104 {
  public readonly shaderId = 'pipeline_shader_104';
  public vertexSource: string;
  public fragmentSource: string;
  public uniforms: ShaderUniforms_104;
