...
export interface ShaderUniforms_82 {
  uTime: number;
...
export class ShaderPipelineModule_82 {
  public readonly shaderId = 'pipeline_shader_82';
  public vertexSource: string;
  public fragmentSource: string;
  public uniforms: ShaderUniforms_82;
