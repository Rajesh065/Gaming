...
export interface ShaderUniforms_88 {
  uTime: number;
...
export class ShaderPipelineModule_88 {
  public readonly shaderId = 'pipeline_shader_88';
  public vertexSource: string;
  public fragmentSource: string;
  public uniforms: ShaderUniforms_88;
