...
export interface ShaderUniforms_47 {
  uTime: number;
...
export class ShaderPipelineModule_47 {
  public readonly shaderId = 'pipeline_shader_47';
  public vertexSource: string;
  public fragmentSource: string;
  public uniforms: ShaderUniforms_47;
