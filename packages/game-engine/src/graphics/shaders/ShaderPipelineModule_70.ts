...
export interface ShaderUniforms_70 {
  uTime: number;
...
export class ShaderPipelineModule_70 {
  public readonly shaderId = 'pipeline_shader_70';
  public vertexSource: string;
  public fragmentSource: string;
  public uniforms: ShaderUniforms_70;
