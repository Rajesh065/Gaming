...
export interface ShaderUniforms_117 {
  uTime: number;
...
export class ShaderPipelineModule_117 {
  public readonly shaderId = 'pipeline_shader_117';
  public vertexSource: string;
  public fragmentSource: string;
  public uniforms: ShaderUniforms_117;
