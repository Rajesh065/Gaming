...
export interface ShaderUniforms_10 {
  uTime: number;
...
export class ShaderPipelineModule_10 {
  public readonly shaderId = 'pipeline_shader_10';
  public vertexSource: string;
  public fragmentSource: string;
  public uniforms: ShaderUniforms_10;
