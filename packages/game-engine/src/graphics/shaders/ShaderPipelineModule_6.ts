...
export interface ShaderUniforms_6 {
  uTime: number;
...
export class ShaderPipelineModule_6 {
  public readonly shaderId = 'pipeline_shader_6';
  public vertexSource: string;
  public fragmentSource: string;
  public uniforms: ShaderUniforms_6;
