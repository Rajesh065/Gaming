...
export interface ShaderUniforms_63 {
  uTime: number;
...
export class ShaderPipelineModule_63 {
  public readonly shaderId = 'pipeline_shader_63';
  public vertexSource: string;
  public fragmentSource: string;
  public uniforms: ShaderUniforms_63;
