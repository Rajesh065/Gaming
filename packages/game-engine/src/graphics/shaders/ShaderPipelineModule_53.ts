...
export interface ShaderUniforms_53 {
  uTime: number;
...
export class ShaderPipelineModule_53 {
  public readonly shaderId = 'pipeline_shader_53';
  public vertexSource: string;
  public fragmentSource: string;
  public uniforms: ShaderUniforms_53;
