...
export interface ShaderUniforms_107 {
  uTime: number;
...
export class ShaderPipelineModule_107 {
  public readonly shaderId = 'pipeline_shader_107';
  public vertexSource: string;
  public fragmentSource: string;
  public uniforms: ShaderUniforms_107;
