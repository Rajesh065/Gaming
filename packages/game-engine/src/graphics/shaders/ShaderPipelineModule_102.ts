...
export interface ShaderUniforms_102 {
  uTime: number;
...
export class ShaderPipelineModule_102 {
  public readonly shaderId = 'pipeline_shader_102';
  public vertexSource: string;
  public fragmentSource: string;
  public uniforms: ShaderUniforms_102;
