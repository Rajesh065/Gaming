...
export interface ShaderUniforms_74 {
  uTime: number;
...
export class ShaderPipelineModule_74 {
  public readonly shaderId = 'pipeline_shader_74';
  public vertexSource: string;
  public fragmentSource: string;
  public uniforms: ShaderUniforms_74;
