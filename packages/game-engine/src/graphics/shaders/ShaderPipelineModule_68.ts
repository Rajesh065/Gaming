...
export interface ShaderUniforms_68 {
  uTime: number;
...
export class ShaderPipelineModule_68 {
  public readonly shaderId = 'pipeline_shader_68';
  public vertexSource: string;
  public fragmentSource: string;
  public uniforms: ShaderUniforms_68;
