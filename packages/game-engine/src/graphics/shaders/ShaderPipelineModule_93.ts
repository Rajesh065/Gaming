...
export interface ShaderUniforms_93 {
  uTime: number;
...
export class ShaderPipelineModule_93 {
  public readonly shaderId = 'pipeline_shader_93';
  public vertexSource: string;
  public fragmentSource: string;
  public uniforms: ShaderUniforms_93;
