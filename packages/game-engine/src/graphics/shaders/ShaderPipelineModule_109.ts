...
export interface ShaderUniforms_109 {
  uTime: number;
...
export class ShaderPipelineModule_109 {
  public readonly shaderId = 'pipeline_shader_109';
  public vertexSource: string;
  public fragmentSource: string;
  public uniforms: ShaderUniforms_109;
