...
export interface ShaderUniforms_52 {
  uTime: number;
...
export class ShaderPipelineModule_52 {
  public readonly shaderId = 'pipeline_shader_52';
  public vertexSource: string;
  public fragmentSource: string;
  public uniforms: ShaderUniforms_52;
