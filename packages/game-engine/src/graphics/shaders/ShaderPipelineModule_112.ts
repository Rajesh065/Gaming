...
export interface ShaderUniforms_112 {
  uTime: number;
...
export class ShaderPipelineModule_112 {
  public readonly shaderId = 'pipeline_shader_112';
  public vertexSource: string;
  public fragmentSource: string;
  public uniforms: ShaderUniforms_112;
