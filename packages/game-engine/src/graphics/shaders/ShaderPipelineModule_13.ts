...
export interface ShaderUniforms_13 {
  uTime: number;
...
export class ShaderPipelineModule_13 {
  public readonly shaderId = 'pipeline_shader_13';
  public vertexSource: string;
  public fragmentSource: string;
  public uniforms: ShaderUniforms_13;
