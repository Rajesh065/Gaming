...
export interface ShaderUniforms_3 {
  uTime: number;
...
export class ShaderPipelineModule_3 {
  public readonly shaderId = 'pipeline_shader_3';
  public vertexSource: string;
  public fragmentSource: string;
  public uniforms: ShaderUniforms_3;
