...
export interface ShaderUniforms_98 {
  uTime: number;
...
export class ShaderPipelineModule_98 {
  public readonly shaderId = 'pipeline_shader_98';
  public vertexSource: string;
  public fragmentSource: string;
  public uniforms: ShaderUniforms_98;
